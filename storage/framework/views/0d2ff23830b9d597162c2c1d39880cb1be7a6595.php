            ...
            <div class="card">
                ...
                <?php if(count($documents)==0): ?>
                    ...
                    <p>You don't have any documents uploaded here.</p>
                       ...
                       <div class="row justify-content-center">
                           <a href="/functions/create" class="btn btn-primary">Upload new document</a>
                       </div>


                <?php else: ?>

                    <table class="unutarnja" style="border: 1px solid black">
                        ...
                        <tr>
                            <td>
                               ...
                               Document type: <br>
                                ...
                                <a href="doc_upload/<?php echo e($document->doc_upload); ?>"download><?php echo e($document->doc_upload); ?></a> <br>

                                <small>Written on <?php echo e($document->created_at); ?> by <?php echo e($document->user->name); ?></small><br>
                            </td>
                            <td>
                                <a href="/functions/<?php echo e($document->id); ?>/edit"><button type="button" class="btn btn-primary">Edit</button></a>
                            </td>
                            <td>
